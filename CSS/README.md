...
- [x] [01. What's the difference between "resetting" and "normalizing" CSS? Which would you choose, and why?](Answers/01.difference-between-resetting-and-normalizing)
...
- [x] 03. Describe Floats and how they work
...
- [x] 04. What are the various clearing techniques and which is appropriate for what context?
  
  > using `display: flex`, using `height: auto` & `overflow:hidden`, using clearfix method

- [x] 05. `display:none` vs `visibility:hidden`
...
- [x] 06. Describe `inline`, `inline-block`, and `block` display elements
...
- [x] 07. Explain CSS sprites, and how you would implement them on a page or site.
...
- [x] 08. What is the difference between classes and IDs in CSS?
...
- [x] 09. Describe BFC(Block Formatting Context) and how it works.
...
- [x] 10. What are your favorite image replacement techniques and which do you use when?
...
- [x] 11. How would you approach fixing browser-specific styling issues?
...
- [x] 12. How do you serve your pages for feature-constrained browsers? What techniques/processes do you use?
  
  > Polyfills or graceful degradation using library like [modernizr](https://modernizr.com/)

- [x] 13. What are the different ways to visually hide content (and make it available only for screen readers)?
...
- [x] 14. Is there any reason you'd want to use translate() instead of absolute positioning, or vice-versa? And why?
...
- [x] 15. What existing CSS frameworks have you used locally, or in production? How would you change/improve them?
...
- [x] 16. Describe relative, fixed, absolute and statically positioned element?
...
- [x] 19. What's the difference between `inline` and `inline-block`?
...
- [x] 20. List as many values for the display property that you can remember.
  
  > `none`, `block`, `inline`, `inline-block`, `table`, `table-cell`, `flex`, `static`, `inherit` 

- [x] 21. What are the advantages/disadvantages of using CSS preprocessors? Describe what you like and dislike about the CSS preprocessors you have used.
...
- [x] 22. Considerations for printing webpages?
...
- [x] 23. Explain how a browser determines what elements match a CSS selector.
...
- [x] 24. How would you implement a web design company that uses non-standard fonts?
...
- [x] 25. What does `* { box-sizing: border-box; }` do? What are its advantages?
...
- [x] 26. How is responsive design different from adaptive design?
...
- [x] 27. Have you ever worked with retina graphics? If so, when and what techniques did you use?
...
- [x] 28. The 'C' in CSS stands for Cascading. How is priority determined in assigning styles (a few examples)? How can you use this system to your advantage?
...
- [x] 29. Describe pseudo-elements and discuss what they are used for.
...
- [x] 30. What's HTML5 shim, what's its usage
...
- [x] 31. What is Media Queries and why it's used?
